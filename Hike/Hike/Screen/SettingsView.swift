        ...
        List{
            ...
            Section{
                ...
                VStack(spacing: 8){
                    ...
                    Text("The hike which looks gorgeous in photos but is even better once you are actually there. The hike that you hope to do again someday. \nFind the best dar hikes in the app.")
                        .font(.footnote)
                        .italic()
                ...
                ScrollView(.horizontal, showsIndicators: false){
                    HStack (spacing: 12){
                        ForEach(alternateAppIcons.indices, id: \.self) { item in
                            Button{
                                print("Icon \(alternateAppIcons[item])")
                                
                                UIApplication.shared.setAlternateIconName(alternateAppIcons[item]){error in
                                    if error != nil {
                                        print("Falhou \(String(describing: error?.localizedDescription))")
                                    }else{
            ...
            Section(
               ...
               //LabeledContent("Application", value: "Hike")
                ...
                CustomListRowView(rowLabel: "Developer", rowIcon: "ellipsis.curlybraces", rowContent: "Alisson", rowColor: .mint)
                
                CustomListRowView(rowLabel: "Designer", rowIcon: "paintpalette", rowContent: "Robert Petras", rowColor: .pink)
                
                CustomListRowView(rowLabel: "Website", rowIcon: "globe", rowColor: .indigo, rowLink:"Credo Academy", rowLinkDestination:"https://credo.academy")
            }//: SECTION
        }//: LIST
